...
function ProjectCard({ project }) {
    return (
        <div>
            <div key={useId()}
                className='flex flex-col items-center gap-4 p-6 rounded-3xl shadow-2xl w-3/4 lg:w-[90%] mx-auto hover:border border-purple-400 hover:scale-105 hover:shadow-purple-400 hover:shadow-md duration-500 ease-in-out'
                >
